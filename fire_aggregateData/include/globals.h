...
extern string sim_name;
extern string params_dir;
...
extern gVar ftmask;		// forest area mask
extern gVar dft;		// dominant forest type
extern gVar pop;		// population density
...
extern gVar ffev;	// fire events
extern gVar ba;		// burned area
extern gVar gfed;	// burned area from gfed database
