...
png(filename = paste0("figures/all_seasons", "(",model,").png"),res = 300,width = 600*3,height = 520*3)
layout(matrix(c(1,1,
                1,1,
                2,3,
                2,3,
                2,3), 5,byrow = T))  # vertical
...
i=3
system(paste0("mkdir full",i))
system("mv figures y_predic* weights_ba.txt fire.2007-1-1-2015-12-31.nc fire_pred_masked.nc full3")
